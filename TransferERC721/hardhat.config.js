...
module.exports = {
  ...
  // iski help se hum apne contract ko verify krteh kisi bhi blockchain pr.
  // access private key from here => https://etherscan.io/apidashboard
  // Username: Yuvraj0911
  // New Password: HkwLMkF!&f
  etherscan: {
    apiKey: {
